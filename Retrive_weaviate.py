...
def get_3_page(list_of_responses):
    ...
    df = df.sort_values(by= ["value_count","type","rank"], ascending=[False,True,True]).drop_duplicates(subset=["source","page"], keep= "first")
...
if __name__ == "__main__":
    ...
    query = "Tại sao phải cắt nguồn điện controller của robot khi thay thế Motor trục 1 trên máy VDCM0001"
